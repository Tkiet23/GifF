...
const musicBtn = document.getElementById("music-btn");
  ...
  const messages = [
   "Hôm nay chính thức là ngày thế giới được “nâng cấp” khi mình ra đời 🎂💝.",
   "Xin chúc mừng sinh nhật người tuyệt vời nhất vũ trụ – là mình đây! 🤭✨.",
   "Mong tuổi mới sẽ đẹp hơn mình (mà chắc hơi khó 😌), hạnh phúc, khỏe mạnh và thành công rực rỡ 🥰🍀.",
   "Chúc cho bản thân luôn tỏa sáng, làm gì cũng “okela” 🤗💞.",
   "Năm nay hứa sẽ cười nhiều hơn, ăn ngon hơn và yêu đời gấp đôi ❤️🎈.",
   "Nào, chúc mình một ngày sinh nhật “sang – xịn – mịn”, ngập tràn quà và lời khen nhé! 🎉✨."
  ];
